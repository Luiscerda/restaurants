...
import { getFavorites, removeFavorite } from '../Utils/actions'
...
function Restaurant({ restaurant, setLoading, toastRef, navigation, setReloadData}) {
    ...
    const confirmRemoveFavorite = () => {
        Alert.alert(
            ...
            "Estas seguro de querer borrar el restaurante de favoritos?",
            [
                {
                    text: "No",
                    style: "cancel"
    ...
    const deleteFavorite = async() => {
        ...
        if(response.statusResponse){
            ...
            toastRef.current.show("Error al eliminar el restaurante de favoritos. Por favor intenta mas tarde.", 3000)
        }
    }
